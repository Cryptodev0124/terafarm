export const masterChefABI = [
  {
    inputs: [
      { internalType: 'contract PyroToken', name: '_pyro', type: 'address' },
      { internalType: 'address', name: '_devaddr', type: 'address' },
      { internalType: 'uint256', name: '_pyroPerTime', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'accPYROPerShare', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [],
    name: 'pyro',
    outputs: [{ internalType: 'contract PyroToken', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_pyroPerTime', type: 'uint256' }],
    name: 'updatePYROPerTime',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
