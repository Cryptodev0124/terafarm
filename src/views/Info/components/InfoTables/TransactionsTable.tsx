...
import { ArrowBackIcon, ArrowForwardIcon, Box, Flex, LinkExternal, Radio, Skeleton, Text } from 'components'
...
const DataRow: React.FC<React.PropsWithChildren<{ transaction: Transaction }>> = ({ transaction }) => {
  ...
  return (
    <ResponsiveGrid>
      <LinkExternal
        href={getBlockExploreLink(transaction.hash, 'transaction', ChainId.SEPOLIA)}
      >
        <Text>
      ...
      <LinkExternal
        href={getBlockExploreLink(transaction.sender, 'address', ChainId.SEPOLIA)}
      >
