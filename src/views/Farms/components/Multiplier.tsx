    ...
    <>
      {rewardCakePerSecond ? (
        <>
          <Text small>
            {isTokenOnly ? 
              "The Multiplier represents the proportion of PYRO rewards each pool receives, as a proportion of the PYRO produced each second."
             : 
          ...
          <Text my="24px" small>
            {" "}
            {isTokenOnly ? "For example, if a 1x pool received 1 PYRO per second, a 40x pool would receive 40 PYRO per second."
        ...
        <>
          <Text small>
            {isTokenOnly ? 
              "The Multiplier represents the proportion of PYRO rewards each pool receives, as a proportion of the PYRO produced each block."
            :
          ...
          <Text my="24px" small>
            {" "}
            {isTokenOnly ? "For example, if a 1x pool received 1 PYRO per block, a 40x pool would receive 40 PYRO per block.":
            "For example, if a 1x pool received 1 PYRO per block, a 40x pool would receive 40 PYRO per block."}
          </Text>
        </>
      )}
    </>
