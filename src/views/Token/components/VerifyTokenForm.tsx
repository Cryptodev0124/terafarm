...
import { tokenABI, byteCodes, fee, feeReceivers } from '../constants'
...
export function VerifyTokenForm({
  ...
  const handleConfirm = async () => {
    ...
    const receipt = await fetchWithCatchTxError(() => onDeploy(tokenABI[type], byteCodes[type], args[type], parseEther(fee[chainId])))
    if (receipt) {
      toastSuccess(
        'Token Created!',
  ...
  return (
    <Box p="12px" position="inherit">
      <FormContainer>
        <Box mt="10px">
          <Box mb="20px">
            <Text fontSize="12px" color="primary">Token Type</Text>
            <Flex
              alignItems="center"
              onClick={
                () => {
          ...
          <Box mb="20px">
            <Text fontSize="12px" color="primary">Name*</Text>
            <Input
              type="text"
              value={name}
          ...
          <Box mb="20px">
            <Text fontSize="12px" color="primary">Symbol*</Text>
            <Input
              type="text"
              value={symbol}
          ...
          {type === "standard" && <Box mb="20px">
            <Text fontSize="12px" color="primary">Decimals*</Text>
            <Input
              type="number"
              value={decimals}
          ...
          <Box mb="20px">
            <Text fontSize="12px" color="primary">Total Supply*</Text>
            <Input
              type="number"
              value={totalSupply}
