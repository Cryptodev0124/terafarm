      ...
      <PageHeader>
        <Flex width="100%" justifyContent="space-between" flexDirection={["column", null, "row"]}>
          <Flex maxWidth="500px" p="24px" flexDirection="column">
            ...
            <Text my="24px">
              Terafarm Sale is a decentralized launchpad, securing its position as the leading platform for users to initiate their own tokens and orchestrate personalized initial token sales, all without the requirement of coding expertise.
            </Text>
            <Flex>
              <Button
                as={NextLinkFromReactRouter}
                to="https://docs.duckstail.com/products/duckstail-sale/multisender"
                target="_blink"
                variant="secondary"
                height="48px"
                width="150px"
          ...
          <Box maxWidth="294px">
            <img src="/images/ducks/Multisender.png" alt="sales" />
          </Box>
        </Flex>
      </PageHeader>
